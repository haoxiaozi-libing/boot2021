...
import com.libing.yygh.user.utils.ConstantWxPropertiesUtils;
import com.libing.yygh.user.utils.HttpClientUtils;
...
public class WeixinApiController {
    ...
    public Result genQrConnect() {
        try {
            ...
            String wxOpenRedirectUrl = "http://localhost:8160/api/ucenter/wx/callback";
